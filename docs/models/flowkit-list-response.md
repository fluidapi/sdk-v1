...
```typescript
import { FlowkitListResponse } from "fluidapi/models";

let value: FlowkitListResponse = {
  data: {
    data: [
      {
        typename: "FlowKit",
...
| ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `data`                                                                    | [models.FlowkitListResponseData](../models/flowkit-list-response-data.md) | :heavy_minus_sign:                                                        | N/A                                                                       |